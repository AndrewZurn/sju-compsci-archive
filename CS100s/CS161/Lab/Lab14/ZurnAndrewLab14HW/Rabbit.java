 ...
 */
public class Rabbit extends ActiveObject implements Racer {
  ...
  private RandomIntGenerator crowdMoves = new RandomIntGenerator(1,10);
   ...
   */
  public Rabbit(double x, double y, double endLine, DrawingCanvas canvas, Race theRace, String name) {
    racerName=name;
    xPos=x;
    yPos=y;
    finish = endLine;
