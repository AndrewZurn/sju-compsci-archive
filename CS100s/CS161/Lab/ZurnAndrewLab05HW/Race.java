 ...
 */
  public void begin() {
    ...
    new Rabbit(200, 200, canvas).setColor(Color.GRAY);
    new Rabbit(200, 230, canvas).setColor(Color.GRAY);
    new Rabbit(240, 200, canvas).setColor(Color.GRAY);
    new Rabbit(240, 230, canvas).setColor(Color.GRAY);
  }
