 ...
 */
public class CryllicCharacters extends FrameWindowController {
  /**
   ...
   */
  public void begin(){
    new Text("Click to see Ethiopic characters.",100,0,canvas);
    cyrillicLetters=new Text("Here are the Ethiopic characters:"+c,0,40,canvas);
  }
