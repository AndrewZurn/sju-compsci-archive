...
/**
 * Zurn, Andrew   Xu, Runbo   Ray, Kyle    BBall Program
 * 
...
public class BBall4One extends FrameWindowController{
  ...
  public void begin() {
    ...
    hoop = new FramedOval( (canvas.getWidth() - HOOPWIDTH)/2, HOOPTOP,HOOPWIDTH, HOOPHEIGHT, canvas);
    ball = new BBall( (canvas.getWidth() - BALLSIZE)/2, BALLY, BALLSIZE, canvas);
  }
