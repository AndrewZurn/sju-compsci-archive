...
public class CalendarController2 extends FrameController implements ActionListener{
  ...
  public void actionPerformed( ActionEvent evt ){
    if(evt.getSource() == addEvent){
      try {
        ...
        System.out.println(
                           "Date entered is invalid. Enter numeric values for the month and day.");
      } catch ( ArrayIndexOutOfBoundsException e ) {
        System.out.println(e.getMessage());
        System.out.println("Date value is out of range.");
        System.out.println("Month must fall between 1 & 12; date must fall within selected month");
      }
      finally{
        System.out.println("I work on all :-)");
      }
    }
    else{
      try {
