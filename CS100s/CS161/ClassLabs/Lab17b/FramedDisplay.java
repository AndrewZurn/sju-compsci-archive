...
public class FramedDisplay {
    ...
    public void highlight() {  border.setColor( HIGHLIGHTCOLOR ); }
    
    // Restore the standard border color
    public void unHighlight() { border.setColor( BORDERCOLOR ); }
    
    // Return the x coord of the left edge of display area
    protected double displayLeft() {    return body.getX();   }
    
    // Return the y coord of the top edge of display area
    protected double displayTop() {    return body.getY();    }
    
    // Return the width of the display area
    protected double displayWidth() { return body.getWidth();  }
    
    // Return the height of the display area
    protected double displayHeight() { return body.getHeight();  }
