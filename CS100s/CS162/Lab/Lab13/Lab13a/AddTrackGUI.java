...
public class AddTrackGUI extends JFrame implements ActionListener {
  ...
  public AddTrackGUI (TreeMap<String, Track> trackMap) {
    ...
    goLabel = new JLabel("Press Go When Last Track Added");
  ...
  public void actionPerformed (ActionEvent evt) {
    ...
    if (source == addPeople) {
      ...
      Track track = new Track(trackTitle, trackLength, trackNumber,
                               trackRating, trackRelease, addPeopleGUI.returnMusicPeople());
