...
public class Record implements Serializable{
  ...
  private String title, genre, producer, releaseDate, format, commentary, numberOfTracks;
  private ArrayList<Track> tracks;
  private ArrayList<Artist> artistName;
  
  
  
  
  public Record (String title, ArrayList<Artist> artistName, String genre, String producer, String releaseDate, 
