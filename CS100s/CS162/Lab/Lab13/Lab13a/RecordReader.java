    ...
    while (file.hasNext()) {
      ...
      while (!line0.equals("&")) {
        ...
        while (!line1.equals("@")) {
          ...
          artistList.add(new Artist(artistName, artistGenre, trackNumbers));
      ...
      recordMap.put(title, new Record(title, artistList, recordGenre, producer, releaseDate, numberOfTracks, recordTracks, format, commentary));
