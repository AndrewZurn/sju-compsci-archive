...
public class SearchController {
     ...
     */
    private static void searchWantedNumberOfStudents(Integer lowNumberWanted, Integer highNumberWanted) throws Exception /*
     * throws Exception
     */ {
...
//        }
        if (lowNumberWanted != null && highNumberWanted != null) {
            if (lowNumberWanted > highNumberWanted) {
                throw new Exception("Error in formatting for Number of Students");
            }
            for (University uni : listBeforeMethod) {
