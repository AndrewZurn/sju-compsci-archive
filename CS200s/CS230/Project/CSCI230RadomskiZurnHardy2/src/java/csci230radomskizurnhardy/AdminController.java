...
public class AdminController {
     ...
     * @param academicsScale Scale 1-5 gauging academic life.
     * @param socialScale Scale 1-5 gauging social life.
     * @param qualityOfLifeScale Scale 1-5 gauging qualify of life.
     */
    public static void addUniversity(String school, String state, String location, String control,
            Integer numberOfStudents, Double percentFemales, Double SATVerbal, Double SATMath,
            Double expenses, Double percentFinancialAid, Integer numberOfApplicants,
            Double percentAdmitted, Double percentEnrolled, Integer academicsScale,
            Integer socialScale, Integer qualityOfLifeScale) throws Exception {

        if (school.equals("") || state.equals("") || location.equals("") || control.equals("")
                || numberOfStudents == null || percentFemales == null || SATVerbal == null || SATMath == null
                || expenses == null || percentFinancialAid == null || numberOfApplicants == null
                || percentAdmitted == null || percentEnrolled == null || academicsScale == null
                || socialScale == null || qualityOfLifeScale == null) {
            throw new Exception("One of the data values was null.");
        } else {
    ...
    public static void addUser(String firstName, String lastName, String username,
            String password, Character type) throws Exception {

        if (firstName.equals("") || lastName.equals("") || username.equals("")
                || password.equals("") || type.toString().equals("")) {
            throw new Exception("One of the data types was null in addUser.");
        } else {
...
//        }
    ...
    /**
     * Will return a list of all the universities within the CMC system.
     *
...
//        AdminController.addUser("Andrew", "Zurn", "Zurn91", "password", 'u');
        ...
        AdminController.editUniversity("ZURN UNIVERSITY", "STATE OF ZURN", "URBAN", "PRIVATE",
                5000, 65.5, 1100.0, 1100.0, 25000.0, 85.9, 2000, 50.0, 25.0, 5, 5, 5);
        universityList = DatabaseController.getAllUniversities();
        for (University uni : universityList) {
            if (uni.getSchool().equals("Zurn University")) {
                System.out.println(uni);
