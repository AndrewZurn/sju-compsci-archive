<%-- 
    Document   : figure14AddNewUser
    Created on : Apr 9, 2012, 7:54:08 PM
    Author     : awzurn
--%>
...
<table style="text-align: left; width: 737px; height: 144px;" border="1" cellpadding="2" cellspacing="2">
  <tbody>
    ...
    <tr>
      ...
      <td style="vertical-align: top; width: 184px;"><input name="Password" type="password"><br>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="vertical-align: top;"><input name="Submit" value="Submit" type="submit">&nbsp; <input name="Reset" value="Reset" type="reset"><br>
      </td>
